...
public class CartScreenHandler extends BaseScreenHandler {
	...
	private boolean isPlaceRushOrder = false; // trong he thong thuc te trien khai se cho phep cho la giao hang nhanh hay khong
	...
	@FXML
	private CheckBox selectRushOrder;
	...
	public CartScreenHandler(Stage stage, String screenPath) throws IOException {
		...
		selectRushOrder.setOnAction(e -> {
			isPlaceRushOrder = selectRushOrder.isSelected();

			btnPlaceOrder.setText(isPlaceRushOrder ? "Place Rush Order" : "Place Order");
	...
	public void requestToPlaceOrder() throws SQLException, IOException {
		try {
			...
			if (!isPlaceRushOrder) placeOrderController = new PlaceOrderController();
			else placeOrderController = new PlaceRushOrderController();
