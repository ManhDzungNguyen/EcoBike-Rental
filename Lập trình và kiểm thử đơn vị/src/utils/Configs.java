...
public class Configs {
	...
	// api constants
	public static final String GET_BALANCE_URL = "https://ecopark-system-api.herokuapp.com/api/card/balance/kscq1_group1_2021";
	...
	public static final String POST_DATA = "{"
			+ " \"secretKey\": \"BZX4If+ud7o=\" ,"
			+ " \"transaction\": {"
			+ " \"command\": \"pay\" ,"
			+ " \"cardCode\": \"kscq1_group1_2021\" ,"
			+ " \"owner\": \"Group 1\" ,"
			+ " \"cvvCode\": \"232\" ,"
			+ " \"dateExpried\": \"1125\" ,"
